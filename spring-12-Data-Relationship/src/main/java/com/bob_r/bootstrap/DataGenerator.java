...
import com.bob_r.entity.*;
import com.bob_r.enums.Status;
import com.bob_r.repository.CartRepository;
import com.bob_r.repository.ItemRepository;
import com.bob_r.repository.MerchantRepository;
...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        PaymentDetails paymentDetail1 = new PaymentDetails(new BigDecimal("140000"),new BigDecimal("10000"),LocalDate.of(2022,4,24));
        ...
        PaymentDetails paymentDetail2 = new PaymentDetails(new BigDecimal("90000"),new BigDecimal("5000"),LocalDate.of(2022,4,29));
